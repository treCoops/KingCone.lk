...
<script src="<?php echo base_url('assets') ?>/Backend/plugins/apex/apexcharts.min.js"></script>
<script src="<?php echo base_url('assets') ?>/Backend/js/dashboard/dash_1.js"></script>
