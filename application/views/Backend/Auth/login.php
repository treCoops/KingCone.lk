...
<head>
    ...
    <link href="<?php echo base_url('assets')?>/Backend/css/authentication/form-2.css" rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets')?>/Backend/css/forms/theme-checkbox-radio.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets')?>/Backend/css/forms/switches.css">
</head>
<body class="form">
        ...
        <div class="form-form-wrap">
            <div class="form-container">
                <div class="form-content">
                    ...
                    <img src="<?php echo base_url('assets') ?>/img/Kong/logo.png" width="50%">

                    <h1 class="">Sign In</h1>
                    <p class="">Log in to your account to continue.</p>

                    <form class="text-left" method="POST" action="<?php echo base_url('BLogin/signIn') ?>">
                        <div class="form">
                            <div id="username-field" class="field-wrapper input">
                                <label for="txt_username">USERNAME</label>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                <input required id="txt_username" name="txt_username" type="text" class="form-control" placeholder="e.g John_Doe">
                            </div>
                            ...
                            <div id="password-field" class="field-wrapper input mb-2">
                                ...
                                <input required id="txt_password" name="txt_password" type="password" class="form-control" placeholder="Password">
...
<script src="<?php echo base_url('assets')?>/Backend/js/authentication/form-2.js"></script>
